...
<body style="background: black;">
	...
	%>
	<div>
		<nav class="navbar navbar-expand-sm bg-dark navbar-light text-center">
			<h4 class="title mb-0 h1 " id= "newh4" style="font-size: 1rem; color:#efac29 ;  padding-left: 1%">LIBRARY
				MANAGEMENT</h4>
			<span class="user mb-0 h5"
				style="padding-left: 57%; padding-right: 1% ; color: #efac29;">Welcome
				${username}</span>
