...
<body>
	...
	<div class="container">
		<div class="fixed-top">
			<div class="header ">
				<b class ="text-center">Library Management</b>
			</div>
		</div>
		<div class="row py-5 mt-5">
			<div class="row">
				<div style="margin-left: 450px">
					<h4>
						<font color="#efac29">Add Books Details</font>
					</h4>
				</div>
					...
					<div class="addBook-form">
						<form id="addBook" action="/add_book" method="post" class="mt-5">
							<div class="form-group px-5">
								<label for="bookCode-input"><font color="#efac29"
							...
							<br>
							<div class="form-group px-5">
								<label for="bookName-input"><font color="#efac29"
							...
							<div class="form-group px-5">
								...
								<label for="author-input"><font color="#efac29"
							...
							<div class="form-group px-5">
								<label for="date-input"><font color="#efac29"
									style="margin-right: 8px">Added On</font></label>

								<%
								Date date = new Date();
								out.print("<p style='color: #efac29; display:inline-block; padding-left:48px'>" + date.toString() + "</p>");
								%>
							</div>
							<br>

							<button class="btn btn-primary text-center" id="add-user" type="submit"
								style="margin-left: 100px">Submit</button>
							<button class="btn btn-danger text-center" id="cancelBtn" type="button"
